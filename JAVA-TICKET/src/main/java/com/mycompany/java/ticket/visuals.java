...
public class visuals extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        title.setText("JAVA TICKET");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ADMINISTRADOR", "CONTENIDOS", "SENCILLO", "PUMPUMPURIN" }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(visuals.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
